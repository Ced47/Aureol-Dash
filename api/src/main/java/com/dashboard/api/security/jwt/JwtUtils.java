...
public class JwtUtils {
    ...
    @Value("${dashboard.app.jwtCookie}")
    private String jwtCookie;

    @Value("${dashboard.app.jwtSecret}")
    private String jwtSecret;

    @Value("${dashboard.app.jwtExpirations}")
    ...
    // generate cookie
    public ResponseCookie generateJwtCookie(CusUsersDetails userPrincipal) {
        String jwt=generateTokenUsername(userPrincipal.getUsername());
    ...
    public boolean validateJwtToken(String authToken) {
        try {
            ...
            logger.error("JWT claimsstring is empty", e.getMessage());
        }
        return false ;
    }
